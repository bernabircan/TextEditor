...
public class ucHarfDegisimi implements Strategy {
        ...
        while (metinIterator.hasNext()) {
            ...
            while (sozlukIterator.hasNext()) {
                ...
                if (metinKelimesi.equals(sozlukKelimesi)) { //kelimse sözlükteki bir kelimeyse okey veriyo
                    ...
                    if (hataliHarfSayisi == 3){
                        if((hataliHarfler[0] == dogruHarfler[1] && hataliHarfler[1] == dogruHarfler[2] && hataliHarfler[2] == dogruHarfler[0]) ||
                                (hataliHarfler[0] == dogruHarfler[2] && hataliHarfler[1] == dogruHarfler[0] && hataliHarfler[2] == dogruHarfler[1])){
                            hataliKelime = false;
